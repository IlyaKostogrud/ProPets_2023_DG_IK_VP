...
export const base_url = ''//'https://ProPets_2023_DG_IK_VP.com/'
export const sign_in_page = `${base_url}/sign_in`
export const add_new_page = `${base_url}/add_new`
export const lost_form_page = `${base_url}/lost_form`
export const found_form_page = `${base_url}/found_form`
export const lost_feed_page = `${base_url}/lost_feed`
export const found_feed_page = `${base_url}/found_feed`
export const home_page = `${base_url}/home`
export const services_page = `${base_url}/services`
export const hotels_page = `${services_page}/hotels`
export const walking_page = `${services_page}/walking`
export const fostering_page = `${services_page}/fostering`
export const vet_help_page = `${services_page}/vet_help`
export const favourites_page = `${base_url}/favourites`
